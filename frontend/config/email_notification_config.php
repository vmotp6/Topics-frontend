...
$email_templates = [
    ...
    'bonus_sent_notification' => [
        'subject' => '【康寧大學】獎金發送通知',
        'template' => 'bonus_sent_notification_template'
    ]
];
...
function getEmailTemplate($template_name, $data = []) {
    $templates = [
        ...
        '
        ,
        'bonus_sent_notification_template' => '
            <!DOCTYPE html>
            <html lang="zh-Hant">
            <head>
                <meta charset="UTF-8">
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="highlight">
                            <h3>✅ 您的推薦獎金已完成發送</h3>
                            <p>您推薦的 <strong>{student_name}</strong> 同學之推薦獎金已完成發送。</p>
                        </div>
                        ...
                        <div class="info-box">
                            ...
                            <p><strong>推薦人：</strong>{recommender_name} ({recommender_student_id})</p>
                            <p><strong>推薦人科系：</strong>{recommender_department}</p>
                            <p><strong>發送時間：</strong>{sent_time}</p>
                        </div>

                        <div class="info-box">
                            <h3>💰 獎金金額</h3>
                            <p>本次已發送獎金金額為：<strong>{bonus_amount}</strong> 元</p>
                            <p style="color:#666; font-size:14px; margin-top:8px;">※ 若同一位被推薦學生有多人通過，獎金將依規則平分（本次同名通過共 {split_count} 筆）。</p>
                        </div>
